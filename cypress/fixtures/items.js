// cypress/fixtures/items.js

/**
 * SAUCEDEMO INVENTORY ITEMS (Public Test Data)
 * Standardized product data for consistent testing.
 * 
 * Note: Prices are hardcoded as strings to match DOM text exactly.
 */
